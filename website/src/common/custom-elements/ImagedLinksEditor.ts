...
export default class ImagedLinksEditor extends HTMLElement implements HasSections<"addButton"> {
...
class ImagedLinkEntry extends HTMLElement implements HasSections<"image"|"nameInput"|"originInput"|"sourceInput"|"hrefInput"|"removeButton"> {
...
customElements.define("imaged-link-entry", ImagedLinkEntry)